	...
	if ($action == 'edit' && arg(2) && is_numeric(arg(2))) {
		...
		$hyperlink_image = htmlspecialchars($result->hyperlink_image);
	}
	?>
	<style type="text/css">
	...
	<div class="pop_cont cat_tpls">
		...
		<div class="poptxt cat_upld">
			...
			<input type="file" accept="image/*" value="<?php echo $hyperlink_image; ?>" id="hyperlinkfile" name="hyperlinkfile" onchange="initiateScan('category','<?php echo 'category/'.htmlspecialchars($cat_id); ?>')"/>&nbsp;
			<?php
